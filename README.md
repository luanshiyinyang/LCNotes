> 本仓库为本人和小伙伴的面试准备刷题库，题目均来自LeetCode（英文版）和面试常见题目，本仓库包含题解，目前由我、[maple-zys](https://github.com/maple-zys)和[hulala1a](https://github.com/hulala1a)维护（想要加入请参考[格式配置](./Application.md)），根目录的`Problems`为题解库文件夹，每道题以题目id为文件夹，其中包含题目说明和题解描述的`markdown`文件（该文件按照二级标题统一格式）和一个对应的题解源码的`py`文件。**本仓库的部分题解包含的优化思路用于面试，面试解题时可以先按照原始思路做，面试官问优化思路再回答。**
...
- [lcof-32 I. 从上到下打印二叉树](./Problems/lcof-032/README.md)
- [lcof-32 II. 从上到下打印二叉树 II](./Problems/lcof-032/README.md)
- [lcof-32 III. 从上到下打印二叉树 III](./Problems/lcof-032/README.md)
...
- [leetcode-100 相同的树](./Problems/0100/README.md)
...
| 剑指Offer 31 | [link](https://leetcode-cn.com/problems/zhan-de-ya-ru-dan-chu-xu-lie-lcof/) | 栈的压入、弹出序列 | Medium | 栈 | [link](./Problems/lcof-031/README.md) | 
| 剑指Offer 32 | [link](https://leetcode-cn.com/problems/cong-shang-dao-xia-da-yin-er-cha-shu-lcof/) | 从上到下打印二叉树 | Medium | 二叉树 | [link](./Problems/lcof-032/README.md) |  
...
| 剑指Offer 49 | [link](https://leetcode-cn.com/problems/chou-shu-lcof/) |丑数| Medium | 动态规划 | [link](./Problems/lcof-049/README.md) |
